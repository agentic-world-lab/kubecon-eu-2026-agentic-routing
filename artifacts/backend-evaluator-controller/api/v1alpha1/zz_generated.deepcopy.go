...
func (in *EvaluationResults) DeepCopyInto(out *EvaluationResults) {
	*out = *in
	if in.CategoryAccuracy != nil {
		in, out := &in.CategoryAccuracy, &out.CategoryAccuracy
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EvaluationResults.
func (in *EvaluationResults) DeepCopy() *EvaluationResults {
	if in == nil {
		return nil
	}
	out := new(EvaluationResults)
	in.DeepCopyInto(out)
	return out
}

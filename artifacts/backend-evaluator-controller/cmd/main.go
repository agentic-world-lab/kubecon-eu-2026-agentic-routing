...
import (
	...
	"github.com/felipevicens/backend-evaluation-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(edgecloudlabsv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "772b8a9f.edgecloudlabs.com",
	...
	if err := (&controller.LLMBackendReconciler{
		...
		Recorder:  mgr.GetEventRecorderFor("llmbackend-controller"),
		Clientset: clientset,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "LLMBackend")
		os.Exit(1)
	}

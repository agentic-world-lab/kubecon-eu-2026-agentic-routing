#!/usr/bin/env python3
"""spain-electricity-cost-mcp MCP server with dynamic tool loading.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="spain-electricity-cost-mcp MCP Server")
    parser.add_argument(
        "--transport",
        choices=["stdio", "http"],
        default="stdio",
    ...
    try:
        ...
        server = DynamicMCPServer(
            name="spain-electricity-cost-mcp",
            tools_dir="src/tools"
        )
